...
@Entity(name = "card")
class Card : AbstractPersistable<UUID?>, Serializable {
    ...
    constructor() : super() {}
    constructor(
        id: UUID?, name: String?, number: String?, responsible: Client?,
        institution: Institution?, owner: UserEntity?
    ) : super() {
        this.id = id
        this.name = name
        this.number = number
    ...
    fun setInstituicao(institution: Institution?) {
        this.institution = institution
    }
}