...
class BankAccount : AbstractPersistable<UUID?>, Serializable {
    ...
    constructor() : super() {}
    constructor(
        id: UUID?, agency: String?, number: String?, dac: String?,
        responsible: Client?, institution: Institution?, owner: UserEntity?
    ) : super() {
        this.id = id
        this.agency = agency
        this.number = number
