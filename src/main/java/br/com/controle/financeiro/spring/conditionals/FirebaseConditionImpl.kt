...
class FirebaseConditionImpl : Condition {
    override fun matches(context: ConditionContext, metadata: AnnotatedTypeMetadata): Boolean {
        val enabled = context.environment.getProperty("br.com.controle.financeiro.firebase.enabled")
        return java.lang.Boolean.parseBoolean(enabled)
    }
}